...
export default function VenuesPage() {
  ...
  const handleCreate = () => {
    ...
    setVenues((prev) => [
      ...prev,
      { venue_id: uuidv4(), venue_name: venueName.trim(), capacity: Number(capacity), address: address.trim(), city: city.trim() },
    ]);
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-left">
                ...
                <tbody className="divide-y divide-slate-100">
                  ...
                  {filtered.length === 0 && (
                    <tr>
                      <td colSpan={canManage ? 5 : 4} className="px-6 py-10 text-center text-sm text-slate-400">
