...
//method apply promo untuk memanggil trigger jika tidak valid
    ...
    <main className="min-h-screen bg-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-10 grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            {promoApplied && (
              <p className="text-sm text-green-600 mt-2">
                ✓ Promo <strong>{promoApplied.promo_code}</strong> berhasil
                diterapkan
              </p>
            )}
          </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 h-fit sticky top-6">
          ...
          <button
            onClick={handleBayar}
            disabled={!selectedCategory || selectedCategory.remaining_quota <= 0}
